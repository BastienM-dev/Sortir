 ...
 */
final class Version20260203073418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participants (no_participant INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(30) NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, telephone VARCHAR(15) DEFAULT NULL, mail VARCHAR(180) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, administrateur TINYINT DEFAULT 0 NOT NULL, actif TINYINT DEFAULT 1 NOT NULL, sites_no_site INT NOT NULL, UNIQUE INDEX UNIQ_716970925126AC48 (mail), INDEX IDX_7169709251C3F4BB (sites_no_site), UNIQUE INDEX participants_pseudo_uk (pseudo), PRIMARY KEY (no_participant)) DEFAULT CHARACTER SET utf8mb4');
